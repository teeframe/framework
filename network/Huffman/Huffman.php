...
class Huffman
{
    ...
    public function set_bits_r(int $node_index, int $bits, int $depth): void
    {
     ...
     */
    public function bubble_sort(array $index_list, array $node_list, int $size): array
    {
        $changed = true;
        while ($changed) {
            $changed = false;
    ...
    public function construct_tree(array $frequencies = self::FREQ_TABLE): void
    {
        $nodes_left_storage = [];
